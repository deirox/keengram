...
const EditProfilePage = () => {
  ...
  useEffect(() => {
    ...
    if (usernameValue !== authorizedUserData.username) {
    ...
    <div className={styles.edit_profile_page__root}>
      <div className={styles.edit_profile_page__top}>
        <button
          ...
          onClick={() => navigate(`/${authorizedUserData.nickname}`)}
        >
          <svg
            aria-label="Назад"
